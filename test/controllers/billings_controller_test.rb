...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post billings_url, params: { billing: { amount: @billing.amount, due_date: @billing.due_date, filled: @billing.filled, tenant_id: @billing.tenant_id, type: @billing.type } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { amount: @billing.amount, due_date: @billing.due_date, filled: @billing.filled, tenant_id: @billing.tenant_id, type: @billing.type } }
